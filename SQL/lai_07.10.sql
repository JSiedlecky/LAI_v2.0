...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Paź 2016, 09:47
...
(1, 'CISCO_1', 'cisco', 2, 'Tydzień', 3, 15, 0, '0000-00-00', '0000-00-00', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.  Donec pellentesque tellus mi, id scelerisque leo sodales vitae. Ut dapibus mi nibh, in interdum turpis commodo non.'),
(2, 'CISCO_2', 'cisco', 1, 'Tydzień', 15, 15, 0, '0000-00-00', '0000-00-00', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.  Donec pellentesque tellus mi, id scelerisque leo sodales vitae. Ut dapibus mi nibh, in interdum turpis commodo non.'),
(4, 'WWW_1', 'www', NULL, NULL, 1, 15, 1, '2016-09-08', '2016-09-29', ''),
...
(1, 'Jakub', 'Siedlecki', 'jakub.w.siedlecki@gmail.com', '+48 535 205 100', 0, NULL, 1, NULL, 1),
...
(12, 'aaa', 'vvv', 'aaa@vvv', '545250101', NULL, NULL, 1, NULL, 1),
(13, 'aaa', 'vvv', 'aaa@vvv', '545250101', NULL, NULL, 1, NULL, 1),
(14, 'aaa', 'vvv', 'aaa@vvv', '545250101', NULL, NULL, 1, NULL, 1);
...
--
ALTER TABLE `left_menu`
  MODIFY `idlm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
