...
--
-- Host: localhost
-- Czas generowania: 15 Lis 2016, 21:41
...
INSERT INTO `permissions` (`idperm`, `idu`, `isGm`, `applications`, `groups`, `payments`, `newsletter`, `users`, `app_add`, `app_delete`, `app_sort`, `app_action`) VALUES
