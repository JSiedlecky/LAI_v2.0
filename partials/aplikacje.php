...
<div class="aplikacjeHeader text-center">
    ...
    <p>
        W naszym kursie nauczysz się języka HTML, CSS oraz projektowania graficznego.
    </p>
</div>
<hr>
<div class="aplikacjeBody col-lg-12">
    <p>
...
Sed sed placerat ante. Donec tempus pretium efficitur. Phasellus odio turpis, varius eget ex quis, porta facilisis massa. Donec a lectus non eros scelerisque bibendum. Suspendisse vel tincidunt erat. In ultrices tellus eget nisi ultricies, ac venenatis massa scelerisque. Nulla non ante ipsum. Duis non mi ac tortor placerat gravida id vel ante. Mauris in quam a leo porttitor maximus. Ut laoreet augue metus. Aenean eleifend rutrum mi ut viverra. Nam et arcu ac justo pharetra euismod nec cursus augue. Proin quis facilisis ipsum. Cras accumsan ligula non sem convallis mattis. Duis ut tristique diam. Quisque convallis dolor vel est pretium ullamcorper.
    </p>
    <div class="aplikacjeSlider">
        <ul class="slider">
